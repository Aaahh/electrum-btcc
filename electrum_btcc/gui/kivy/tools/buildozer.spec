...
# (str) Package name
package.name = Electrum_BTCC

# (str) Package domain (needed for android/ios packaging)
package.domain = org.electrum_btcc
...
source.exclude_dirs = bin, build, dist, contrib, electrum_btcc/gui/qt, electrum_btcc/gui/kivy/tools, electrum_btcc/gui/kivy/theming/light
# (list) List of exclusions using pattern matching
source.exclude_patterns = Makefile,setup*

# (str) Application versioning (method 1)
version.regex = APK_VERSION = '(.*)'
version.filename = %(source.dir)s/electrum_btcc/version.py
...
android.add_src = electrum_btcc/gui/kivy/data/java-classes/
...
android.manifest.intent_filters = electrum_btcc/gui/kivy/tools/bitcoin_intent.xml
