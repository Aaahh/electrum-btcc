...
from electrum_btcc.util import base_units_list
...
from electrum_btcc import coinchooser
        ...
        ScrollView:
            GridLayout:
                ...
                SettingsItem:
                    ...
                    description: _("Base unit for Bitcored amounts.")
...
class SettingsDialog(Factory.Popup):
    ...
    def proxy_dialog(self, item, dt):
        if self._proxy_dialog is None:
            ...
            popup = Builder.load_file('electrum_btcc/gui/kivy/uix/ui_screens/proxy.kv')
