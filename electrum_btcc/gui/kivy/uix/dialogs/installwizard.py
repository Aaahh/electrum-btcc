...
from electrum_btcc.base_wizard import BaseWizard
from electrum_btcc.util import is_valid_email
...
#:import _ electrum_btcc.gui.kivy.i18n._
...
<WizardTextInput@TextInput>
    ...
    background_active: 'atlas://electrum_btcc/gui/kivy/theming/light/create_act_text_active'
    background_normal: 'atlas://electrum_btcc/gui/kivy/theming/light/create_act_text_active'
    size_hint_y: None
    height: '48sp'
    ...
    BoxLayout:
        ...
        GridLayout:
            ...
            Label:
                ...
                font_size: '33sp'
                font_name: 'electrum_btcc/gui/kivy/data/fonts/tron/Tr2n.ttf'
        GridLayout:
            cols: 1
            id: crcontent
            spacing: '1dp'
...
<SeedButton@Button>:
    ...
    color: .1, .1, .1, 1
    background_normal: 'atlas://electrum_btcc/gui/kivy/theming/light/white_bg_round_top'
...
<AddXpubDialog>
    ...
    GridLayout
        ...
        IconButton:
            ...
            icon: 'atlas://electrum_btcc/gui/kivy/theming/light/camera'
            size_hint: 1, None
        WizardButton:
            text: _('Paste')
...
class RestoreSeedDialog(WizardDialog):
    ...
    def __init__(self, wizard, **kwargs):
        ...
        from electrum_btcc.mnemonic import Mnemonic
        from electrum_btcc.old_mnemonic import words as old_wordlist
...
class InstallWizard(BaseWizard, Widget):
    ...
    def waiting_dialog(self, task, msg, on_finished=None):
        ...
        app.show_info_bubble(
            text=msg, icon='atlas://electrum_btcc/gui/kivy/theming/light/important',
