...
<InvoiceItem@CardItem>
    ...
    status: ''
    date: ''
    icon: 'atlas://electrum_btcc/gui/kivy/theming/light/important'
    Image:
        id: icon
        source: root.icon
        size_hint: None, 1
...
from electrum_btcc.gui.kivy.uix.context_menu import ContextMenu
...
pr_icon = {
    PR_UNPAID: 'atlas://electrum_btcc/gui/kivy/theming/light/important',
    PR_UNKNOWN: 'atlas://electrum_btcc/gui/kivy/theming/light/important',
    PR_PAID: 'atlas://electrum_btcc/gui/kivy/theming/light/confirmed',
    PR_EXPIRED: 'atlas://electrum_btcc/gui/kivy/theming/light/close'
}
