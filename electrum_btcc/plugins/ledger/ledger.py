...
from electrum_btcc import bitcoin, constants
from electrum_btcc.bitcoin import TYPE_ADDRESS, int_to_hex, var_int
from electrum_btcc.i18n import _
from electrum_btcc.plugin import BasePlugin
...
from electrum_btcc.util import print_error, bfh, bh2u, versiontuple
...
MSG_NEEDS_FW_UPDATE_SEGWIT = _('Firmware version (or "Bitcored" app) too old for Segwit support. Please update at') + \
                      ' https://www.ledgerwallet.com'
        ...
        if not self.preflightDone:
            try:
                ...
                if (e.sw == 0x6d00 or e.sw == 0x6700):
                    raise Exception(_("Device not in Bitcored mode")) from e
                raise e
