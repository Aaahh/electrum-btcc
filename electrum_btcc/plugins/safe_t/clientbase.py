...
from electrum_btcc.util import PrintError, UserCancelled
from electrum_btcc.keystore import bip39_normalize_passphrase
from electrum_btcc.bitcoin import serialize_xpub, convert_bip32_path_to_list_of_uint32
    ...
    def callback_PassphraseRequest(self, req):
        ...
        if self.creating_wallet:
            msg = _("Enter a passphrase to generate this wallet.  Each time "
                    ...
                    "access the bitcoreds in the wallet.").format(self.device)
        else:
