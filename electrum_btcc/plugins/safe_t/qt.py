...
from electrum_btcc.gui.qt.util import *
from electrum_btcc.i18n import _
from electrum_btcc.plugin import hook, DeviceMgr
from electrum_btcc.util import PrintError, UserCancelled, bh2u
from electrum_btcc.wallet import Wallet, Standard_Wallet
...
RECOMMEND_PIN = _(
    ...
    "for your bitcoreds if your device is lost or stolen.")
PASSPHRASE_NOT_PIN = _(
    "If you forget a passphrase you will be unable to access any "
    "bitcoreds in the wallet behind it.  A passphrase is not a PIN. "
    ...
    def request_safe_t_init_settings(self, wizard, method, device):
        ...
        if method in [TIM_NEW, TIM_RECOVER]:
            ...
            if method == TIM_MNEMONIC:
                ...
                def set_enabled():
                    from electrum_btcc.keystore import is_xprv
...
class SettingsDialog(WindowModalDialog):
    ...
    def __init__(self, window, plugin, keystore, device_id):
        ...
        def wipe_device():
            ...
            if wallet and sum(wallet.get_balance()):
                ...
                msg = _("Are you SURE you want to wipe the device?\n"
                        "Your wallet still has bitcoreds in it!")
                if not self.question(msg, title=title,
        ...
        pin_msg = QLabel(_("PIN protection is strongly recommended.  "
                           ...
                           "stealing your bitcoreds if they obtain physical "
        ...
        clear_pin_warning = QLabel(
            _("If you disable your PIN, anyone with physical access to your "
              "{} device can spend your bitcoreds.").format(plugin.device))
        ...
        wipe_device_warning = QLabel(
            _("Only wipe a device if you have the recovery seed written down "
              "and the device wallet(s) are empty, otherwise the bitcoreds "
