...
try:
    from electrum_btcc.crypto import Hash, EncodeAES, DecodeAES
    from electrum_btcc.bitcoin import (TYPE_ADDRESS, push_script, var_int, public_key_to_p2pkh, is_address,
                                      serialize_xpub, deserialize_xpub)
    from electrum_btcc import ecc
    from electrum_btcc.ecc import msg_magic
    from electrum_btcc.wallet import Standard_Wallet
    from electrum_btcc import constants
    from electrum_btcc.transaction import Transaction
    from electrum_btcc.i18n import _
    from electrum_btcc.keystore import Hardware_KeyStore
    from ..hw_wallet import HW_PluginBase
    from electrum_btcc.util import print_error, to_string, UserCancelled
    from electrum_btcc.base_wizard import ScriptTypeNotSupported, HWD_SETUP_NEW_WALLET
...
class DigitalBitbox_Client():
    ...
    def dbb_generate_wallet(self):
        ...
        filename = ("Electrum-BTCC-" + time.strftime("%Y-%m-%d-%H-%M-%S") + ".pdf")
