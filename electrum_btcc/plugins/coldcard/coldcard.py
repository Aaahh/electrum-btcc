...
from electrum_btcc.bitcoin import serialize_xpub, deserialize_xpub, InvalidMasterKeyVersionBytes
from electrum_btcc import constants
from electrum_btcc.bitcoin import TYPE_ADDRESS, int_to_hex
from electrum_btcc.i18n import _
from electrum_btcc.plugin import BasePlugin, Device
from electrum_btcc.keystore import Hardware_KeyStore, xpubkey_to_pubkey, Xpub
from electrum_btcc.transaction import Transaction
from electrum_btcc.wallet import Standard_Wallet
from electrum_btcc.crypto import hash_160
...
try:
    ...
    class ElectrumColdcardDevice(ColdcardDevice):
        ...
        def mitm_verify(self, sig, expect_xpub):
            ...
            from electrum_btcc.ecc import ECPubkey
