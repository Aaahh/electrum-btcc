...
from electrum_btcc import storage, bitcoin, keystore
from electrum_btcc import Transaction
from electrum_btcc import SimpleConfig
from electrum_btcc.address_synchronizer import TX_HEIGHT_UNCONFIRMED, TX_HEIGHT_UNCONF_PARENT
from electrum_btcc.wallet import sweep, Multisig_Wallet, Standard_Wallet, Imported_Wallet
from electrum_btcc.util import bfh, bh2u
from electrum_btcc.transaction import TxOutput
...
class TestWalletKeystoreAddressIntegrityForMainnet(SequentialTestCase):
    ...
    def test_electrum_seed_segwit(self, mock_write):
        ...
        self.assertEqual(w.get_receiving_addresses()[0], 'btcc1q3g5tmkmlvxryhh843v4dz026avatc0zz8xd49e')
        self.assertEqual(w.get_change_addresses()[0], 'btcc1qdy94n2q5qcp0kg7v9yzwe6wvfkhnvyzjazfzj3')
    ...
    def test_electrum_seed_segwit_passphrase(self, mock_write):
        ...
        self.assertEqual(w.get_receiving_addresses()[0], 'btcc1qx94dutas7ysn2my645cyttujrms5d9p564qe9t')
        self.assertEqual(w.get_change_addresses()[0], 'btcc1qcywwsy87sdp8vz5rfjh3sxdv6rt95kujfu64lc')
    ...
    def test_bip39_seed_bip84_native_segwit(self, mock_write):
        ...
        self.assertEqual(w.get_receiving_addresses()[0], 'btcc1qcr8te4kr609gcawutmrza0j4xv80jy8z4nqduv')
        self.assertEqual(w.get_change_addresses()[0], 'btcc1q8c6fshw2dlwun7ekn9qwf37cu2rn755u9ym7p0')
    ...
    def test_electrum_multisig_seed_segwit(self, mock_write):
        ...
        self.assertEqual(w.get_receiving_addresses()[0], 'btcc1qvzezdcv6vs5h45ugkavp896e0nde5c5lg5h0fwe2xyfhnpkxq6gqa9a79a')
        self.assertEqual(w.get_change_addresses()[0], 'btcc1qxqf840dqswcmu7a8v82fj6ej0msx08flvuy6kngr7axstjcaq6usxndfdg')
    ...
    def test_bip32_extended_version_bytes(self, mock_write):
        ...
        self.assertEqual(w.get_receiving_addresses()[0], 'btcc1qtuynwzd0d6wptvyqmc6ehkm70zcamxpsncccvf')
        self.assertEqual(w.get_change_addresses()[0], 'btcc1qjy5zunxh6hjysele86qqywfa437z4xwmm96rkx')
        ...
        self.assertEqual(w.get_receiving_addresses()[0], 'btcc1q84x0yrztvcjg88qef4d6978zccxulcmc9y88xcg4ghjdau999x7qaxz66u')
        self.assertEqual(w.get_change_addresses()[0], 'btcc1q0fj5mra96hhnum80kllklc52zqn6kppt3hyzr49yhr3ecr42z3tsqjxpj4')
...
class TestWalletKeystoreAddressIntegrityForTestnet(TestCaseForTestnet):
    ...
    def test_bip32_extended_version_bytes(self, mock_write):
        ...
        self.assertEqual(w.get_receiving_addresses()[0], 'tbtcc1qtuynwzd0d6wptvyqmc6ehkm70zcamxpsy2m3lr')
        self.assertEqual(w.get_change_addresses()[0], 'tbtcc1qjy5zunxh6hjysele86qqywfa437z4xwmvhe29v')
        ...
        self.assertEqual(w.get_receiving_addresses()[0], 'tbtcc1q84x0yrztvcjg88qef4d6978zccxulcmc9y88xcg4ghjdau999x7qkfxy9f')
        self.assertEqual(w.get_change_addresses()[0], 'tbtcc1q0fj5mra96hhnum80kllklc52zqn6kppt3hyzr49yhr3ecr42z3tstazldq')
...
class TestWalletSending(TestCaseForTestnet):
    ...
    def test_sweep_p2pk(self):
        ...
        network = NetworkMock()
        dest_addr = 'tbtcc1q3ws2p0qjk5vrravv065xqlnkckvzcpcl0k88vr'
...
class TestWalletOfflineSigning(TestCaseForTestnet):
    ...
    def test_sending_offline_xprv_online_xpub_p2pkh(self, mock_write):
        ...
        # create unsigned tx
        outputs = [TxOutput(bitcoin.TYPE_ADDRESS, 'tbtcc1qp0mv2sxsyxxfj5gl0332f9uyez93su9cszcqyh', 2500000)]
    ...
    def test_sending_offline_wif_online_addr_p2pkh(self, mock_write):  # compressed pubkey
        ...
        # create unsigned tx
        outputs = [TxOutput(bitcoin.TYPE_ADDRESS, 'tbtcc1quk7ahlhr3qmjndy0uvu9y9hxfesrtahtj48k8j', 2500000)]
        tx = wallet_online.mktx(outputs=outputs, password=None, config=self.config, fee=5000)
        tx.set_rbf(True)
        tx.locktime = 1325340
    ...
    def test_sending_offline_wif_online_addr_p2wpkh(self, mock_write):
        ...
        wallet_online = WalletIntegrityHelper.create_imported_wallet(privkeys=False)
        wallet_online.import_address('tbtcc1qm2eh4787lwanrzr6pf0ekf5c7jnmghm2ad526v')
    ...
    def test_sending_offline_hd_multisig_online_addr_p2wsh(self, mock_write):
        ...
        # ^ third seed: hedgehog sunset update estate number jungle amount piano friend donate upper wool
        wallet_online = WalletIntegrityHelper.create_imported_wallet(privkeys=False)
        wallet_online.import_address('tbtcc1q83p6eqxkuvq4eumcha46crpzg4nj84s9p0hnynkxg8nhvfzqcc7q26lnr9')
...
class TestWalletHistory_EvilGapLimit(TestCaseForTestnet):
    ...
    def test_restoring_wallet_txorder1(self, mock_write):
        ...
        w.receive_history_callback('tbtcc1qgh5c088he4d559wl0hw27hrdeg8p2z96c3td9f',  # HD index 1
                                   [('268fce617aaaa4847835c2212b984d7b7741fdab65de22813288341819bc5656', 1316917)],
                                   {})
        w.synchronize()
        w.receive_history_callback('tbtcc1qm0ejr6g964zt2jux5te7m9ds43n28hds528z0k',  # HD index 3
                                   [('511a35e240f4c8855de4c548dad932d03611a37e94e9203fdb6fc79911fe1dd4', 1316912)],
                                   {})
        w.synchronize()
        w.receive_history_callback('tbtcc1qj4pnq958k89zcem3342lhcgyz0rnmhkzxjy3gk',  # HD index 4
                                   [('fde0b68938709c4979827caa576e9455ded148537fdb798fd05680da64dc1b4f', 1316917)],
                                   {})
        w.synchronize()
        w.receive_history_callback('tbtcc1q3pyjwpm8wxgvquak240mprfhaydmkawcfhg2zs',  # HD index 15
                                   [('511a35e240f4c8855de4c548dad932d03611a37e94e9203fdb6fc79911fe1dd4', 1316912)],
                                   {})
        w.synchronize()
        w.receive_history_callback('tbtcc1qr0qjp99ygawul0eylxfqmt7alygye22mtenjfm',  # HD index 25
                                   [('fde0b68938709c4979827caa576e9455ded148537fdb798fd05680da64dc1b4f', 1316917),
                                    ('268fce617aaaa4847835c2212b984d7b7741fdab65de22813288341819bc5656', 1316917)],
                                   {})
        w.synchronize()
