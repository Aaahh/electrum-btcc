...
class SimpleConfig(PrintError):
    ...
    def convert_version_3(self):
        ...
        if isinstance(base_unit, str):
            ...
            map_ = {'btcc':8, 'mbtcc':5, 'ubtcc':2, 'bits':2, 'sat':0}
    ...
    def get_wallet_path(self):
        ...
        old_path = os.path.join(self.path, "electrum-btcc.dat")
...
def read_user_config(path):
    """Parse and store the user config settings in electrum-btcc.conf into user_config[]."""
    if not path:
        return {}
