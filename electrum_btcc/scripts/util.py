...
from electrum_btcc.network import parse_servers
...
def get_peers():
    ...
    if server is None:
        print("You need to set a secure server, for example (for mainnet): 'electrum-btcc setconfig server electrum-btcc.bysh.me:50002:s'")
        return []
