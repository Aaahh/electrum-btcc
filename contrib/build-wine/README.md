...
These scripts can be used for cross-compilation of Windows Electrum-BTCC executables from Linux/Wine.
...
[that script](https://github.com/aaahh/electrum-btcc/blob/master/.travis.yml) might help.
